...
import { Assignment, Schedule, LeaveRequest, Submission } from "@/types";
    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          ...
          {user?.role === "STUDENT" && (
            <Button onClick={() => navigate("/leave-requests/create")}>
              <PlusIcon size={16} className="mr-2" />
              Request Leave
            </Button>
          )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="mt-4">
              <Button variant="outline" className="w-full" onClick={() => navigate("/schedules")}>
                View All
              </Button>
            </div>
          </DashboardCard>
          ...
          {user?.role === "TEACHER" && (
            ...
            >
              ...
              <div className="mt-4">
                <Button variant="outline" className="w-full" onClick={() => navigate("/leave-requests")}>
                  View All
                </Button>
              </div>
            </DashboardCard>
